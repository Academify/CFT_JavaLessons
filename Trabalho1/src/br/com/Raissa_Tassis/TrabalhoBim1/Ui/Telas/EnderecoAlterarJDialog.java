 ...
 */
public class EnderecoAlterarJDialog extends javax.swing.JDialog {
    ...
    public EnderecoAlterarJDialog(java.awt.Frame parent, boolean modal, Usuario u, Endereco endereco) {
        super(parent, modal);
        initComponents();
        ...
        this.setTitle("Alterar endereço");
    ...
    private void initComponents() {
        ...
        Alterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Raissa_Tassis/TrabalhoBim1/Ui/Imagens/pencil_go.png"))); // NOI18N
    ...
    private void AlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AlterarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Erro no alteração", HEIGHT);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnderecoAlterarJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EnderecoAlterarJDialog dialog = new EnderecoAlterarJDialog(new javax.swing.JFrame(), true, null, null);
