 ...
 * @author aluno
 */
public class HqRelatorio extends Dao {

    public void emitirRelatorio(List<Hq> hqList){
         String reportSrcFile = "./hqs.jasper";
        ...
        try {
            JRBeanCollectionDataSource jrBean = new JRBeanCollectionDataSource(hqList);
    ...
    public void processar() throws JRException, ClassNotFoundException, SQLException, Exception {
        ...
        String reportSrcFile = "./hqs.jrxml";
