...
public class CUDProduto extends javax.swing.JFrame {

    private ProdutoDao pDao = new ProdutoDao();
    private List<Produto> lista = new ArrayList();
    private Produto p = new Produto();
    private BuscaProduto buscaProduto = new BuscaProduto(this, true);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(TituloCUDProdutos)
    ...
    private void BotaoBuscarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoBuscarProdutoActionPerformed
        ...
        Produto prod = buscaProduto.getProduto();
        exibirDados(prod);
    ...
    void habilitarJTF(){
     ...
     void exibirDados(Produto prod) {
        NomeProdutoJTF.setText(prod.getNome());
        CodProdutoJTF.setText(Integer.toString(prod.getCod()));
        MarcaProdutoJTF.setText(prod.getMarca());
        PrecoCompraProdutoJTF.setText(Double.toString(prod.getPrecoCompra()));
        PrecoVendaProdutoJTF.setText(Double.toString(prod.getPrecoVenda()));
        QtdEstoqueProdutoJTF.setText(Integer.toString(prod.getQtdEstoque()));
        BotaoExcluirProduto.setEnabled(true);
    }
