...
public class CompraControle {
    ...
    public void inserirCompra(Compra c , List<ProdutoCV> listaP) throws DaoException {
        ...
        if (validarCodFornecedor(c.getCodFornecedor()) && listaP.size()>0){
            try{
                ...
                for (int i=0; i<listaP.size(); i++){
                    if (validarCodProduto(listaP.get(i).getCod())){
    ...
    private boolean validarCodFornecedor(int codFornecedor) {
    ...
    private boolean validarCodCompra(int codcompra) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private boolean validarCodProduto(int codproduto) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private boolean validarProdutoEmCompra(int codcompra, int codproduto) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}