...
public class FornecedorUi {
    public static void testesFornecedor() throws DaoException, Exception{
        ...
        f.setCnpj("123");
        f.setNome("Fábrica de Batatas");
        f.setTelefone("9898");
        
        Fornecedor f2 = new Fornecedor();
        f2.setNome("Fábrica de Tomates");
        f2.setCnpj("456");
        f2.setTelefone("7845");
        ...
        try{
            ...
            System.out.println("\n Todos os objetos de nome Fábrica de Batatas");
            ListaForn = fDao.consultarPorNome("Fábrica de Batatas");
            for(int i=0; i<ListaForn.size(); i++){
                System.out.println(ListaForn.get(i).getNome());
            }
