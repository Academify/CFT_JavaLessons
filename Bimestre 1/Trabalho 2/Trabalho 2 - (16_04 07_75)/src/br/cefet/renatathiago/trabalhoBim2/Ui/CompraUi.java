...
public class CompraUi {
    ...
    public static void testesCompra() throws DaoException, Exception{
        ...
        pcv = pDao.deProdutoParaProdutoCVCompra(pDao.consultarPorCod(3));
        pcv.setQtd(10);
        ProdutoCV pcv2 = new ProdutoCV();
        pcv2 = pDao.deProdutoParaProdutoCVCompra(pDao.consultarPorCod(2));
        pcv2.setQtd(15);
        listaP1.add(pcv);
        listaP1.add(pcv2);
        c.setListaP(listaP1);
        ...
        pcv3 = pDao.deProdutoParaProdutoCVCompra(pDao.consultarPorCod(3));
        pcv3.setQtd(17);
        ProdutoCV pcv4 = new ProdutoCV();
        pcv4 = pDao.deProdutoParaProdutoCVCompra(pDao.consultarPorCod(2));
        pcv4.setQtd(18);
        listaP2.add(pcv3);
        listaP2.add(pcv4);  
