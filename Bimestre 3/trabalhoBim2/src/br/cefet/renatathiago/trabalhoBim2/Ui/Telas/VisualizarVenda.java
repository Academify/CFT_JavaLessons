...
public class VisualizarVenda extends javax.swing.JDialog {
    ...
    public VisualizarVenda(java.awt.Frame parent, boolean modal, Venda c) throws DaoException {
        super(parent, modal);
        initComponents();
        limparCampos();
        ...
        preencherTabela(vControle.consultarProdutos(c.getCod()));        
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(clienteTf, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
    ...
    List<ProdutoCV> getProdutos(){
        ...
        for (int i = 0; i<jTable1.getRowCount();i++){
            ...
            p.setPrecoVenda(Double.parseDouble((String) jTable1.getValueAt(i, 3)));
