...
public class CompraFornecedorRelatorio extends Dao {
    
    public void processar() throws JRException, ClassNotFoundException, SQLException, DaoException{
        String reportSrcFile = "fornecedorCompra.jrxml";
    ...
    public void emitirRelatorio(List<CompraFornecedor> pList){
        
        String reportSource = "fornecedorCompra.jasper";
